package me.virizion.corpses.nms.nmsclasses;
...
import me.virizion.corpses.nms.nmsclasses.packetlisteners.PcktIn_v1_8_R2;
...
public class NMSCorpses_v1_8_R2 implements Corpses {
	...
	public void registerPacketListener(Player p) {
		PcktIn_v1_8_R2.registerListener(p);
	}
